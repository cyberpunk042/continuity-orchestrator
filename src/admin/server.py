...
from .helpers import fresh_env, trigger_mirror_sync_bg, gh_repo_flag
...
def create_app() -> Flask:
    ...
    # Thin wrappers — delegate to helpers module, passing project_root
    def _fresh_env() -> dict:
        return fresh_env(project_root)

    def _trigger_mirror_sync_bg(mode: str = "all") -> bool:
        return trigger_mirror_sync_bg(project_root, mode)

    def _gh_repo_flag() -> list:
        return gh_repo_flag(project_root)
